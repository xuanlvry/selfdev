...
/**
 * 本例说明：
 *      对pattern1模板方法的扩展示例。H1型号的喇叭想让它响就响，H2型号的喇叭不要有声音。
 *
 *
...
public class Client {
    public static void main(String[] args) {
        //悍马1根据需要喇叭
        HummerModelH1 hummerModel1 = new HummerModelH1();
        hummerModel1.setAlarm(true);
        hummerModel1.run();

        //悍马2不要喇叭
        HummerModelH2 hummerModel2 = new HummerModelH2();
        hummerModel2.run();
    }
}
